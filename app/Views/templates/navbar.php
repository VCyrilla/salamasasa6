			...
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<?php else: ?>
								<img src="<?= base_url('path/to/default/favicon.ico'); ?>" alt="Profile Icon" style="width: 30px; height: 30px; border-radius: 50%;">
							<?php endif; ?>
						</a>
						...
						<li><span class="dropdown-item"><?= session()->get('user_type') ?></span></li>
							...
							<li><a class="dropdown-item" href="<?= site_url(session()->get('user_type') . '/profile'); ?>">Profile</a></li>
